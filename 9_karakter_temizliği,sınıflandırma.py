# -*- coding: utf-8 -*-
"""9-karakter temizliği,sınıflandırma

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1JYgJIwex4b-MPVVnlsoQgQdaCuk9TXPK
"""
...
"""| Özellik       | Açıklama                                                           |
| ------------- | ------------------------------------------------------------------ |
| `normalize()` | Karakter temizliği + küçük harfe çevirme                           |
| Tam eşleşme   | Hızlı sonuç + yüksek doğruluk                                      |
| Fuzzy eşleşme | Yakın ama tam olmayan kodlar da bulunur                            |
| Sınıflandırma | "TAM EŞLEŞME", "YAKIN EŞLEŞME", "EŞLEŞMEDİ" şeklinde detaylı bilgi |
| Excel Raporu  | Hem eşleşen hem eşleşmeyen veriler dışarı alınabilir               |


Bu aşamanın sonunda
il 500 data için fuzzy,eşleşme oranı, kod sütunlarını otomatik bulabilme ,excel raporu,normalize,ürün adı karşılaştırma ,sınıflandırma özellikleri geliştirilerek uygulanmıştır.
"""